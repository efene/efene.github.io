...
BLOG_AUTHOR = "Mariano Guerra"  # (translatable)
BLOG_TITLE = "Efene Language"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "https://efene.github.io/blog/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://efene.github.io/blog/"
BLOG_EMAIL = "mariano@marianoguerra.org"
BLOG_DESCRIPTION = "Efene Programming Language Blog"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('https://twitter.com/EfeneLang', 'My Twitter', 'icon-twitter'),
        ('https://github.com/efene', 'My Github', 'icon-github'),
    )
}
